...
?> 
<table class="table" style="vertical-align: middle; text-align:  
center;"> 
...
editdata" data-dataid="<?php echo $se_data['u_id']; ?>" data-toggle="modal" data target="#updateModalCenter">Update</button> 
<button type="button" class="btn btn-danger  
deletedata" data-dataid="<?php echo $se_data['u_id']; ?>" data-toggle="modal" data target="#deleteModalCenter">Delete</button> 
</td> 
</tr> 
<?php }}else{ echo "<tr><td colspan='7'><h2>No Result  
Found</h2></td></tr>"; } ?> 
 </tbody> 
</table> 
